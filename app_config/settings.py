...
import os
from dotenv import load_dotenv # To use vertual environment
...
SECRET_KEY = 'django-insecure-#f369+1l28!j%+u!0ky$dlxgbn0h%)=6uyamdguh^*zjkbmg6y'
...
# Access settings of static files
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PROJECT_NAME = os.path.basename(BASE_DIR)
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]
STATIC_ROOT = os.path.join(BASE_DIR, "static") # 本番用に変更
MEDIA_URL = '/media/'
